...
const Testimonials = () => {
  ...
  return (
    <section
      id="clients"
      className={`${styles.paddingY} ${styles.flexCenter} flex-col relative mb-6 md:mb-12
    `}
      ref={sectionRef}
    >
      {/* To do */}
      <div
        ref={gradientRef}
        className="absolute z-[0] w-[60%] h-[60%] -right-[30%] rounded-full blue__gradient"
      />

      <div
        className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 z-[1] "
        ref={headerRef}
      >
      ...
      <div
        className="relative  w-screen max-w-[100vw] h-[480px] "
        ref={carouselRef}
      >
        <div
          className="flex gap-3 sm:gap-5  h-fit justify-start feedback-container absolute z-[1]"
          ref={testimonialsRef}
        >
