    ...
    <div className={`flex  w-[370px] justify-between flex-col px-10 py-12 rounded-[20px]   feedback-card  `}>
      ...
      <div className="flex flex-row">
        ...
        <div className="flex flex-col ml-4">
          <h3 className="font-poppins font-semibold text-[20px] leading-[32px] text-white ">{name}</h3>
          <h3 className="font-poppins font-normal text-[16px] leading-[24px] text-white opacity-60">{title}</h3>
        </div>
      </div>
